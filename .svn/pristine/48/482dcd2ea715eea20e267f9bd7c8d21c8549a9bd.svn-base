...
namespace SECI.FactoryData.Repositories
{
    public class RepositorioMapas : BaseRepository
    {
        ...
        public void BorraMapaByIdMapa(int idMapa)
        {
            try
            {
                base._ProviderDB.ExecuteNonQuery("spGetMostrarActivo", new DbParameter[] {
                    DataFactory.GetObjParameter(GlobalConfiguration.ProviderDB, "@llmapa", DbType.Int32, idMapa )
                    });
            }
            catch (Exception ex)
            {
