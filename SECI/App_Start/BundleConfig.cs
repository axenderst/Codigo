...
namespace SECI
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/NuevoMapa").Include("~/Scripts/SICE/NuevoMapa.js"));
            bundles.Add(new ScriptBundle("~/bundles/Administracion").Include("~/Scripts/SICE/Administracion.js"));
            #endregion
        }
    }
}
